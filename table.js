...
export const createTable = (columnsArray, dataArray, tableId) => {
  if (
    ...
    throw new Error(
      "Para a correta execução, precisamos de um array com as colunas, outro com as informações das linhas e tambem o id do elemento tabela"
    );
  }
...
function createTableHeader(tableReference, columnsArray) {
  ...
  function createTheadElement(tableReference) {
    const thead = document.createTheadElement("thead"); //<thead></thead>
  ...
  ["bg-blue-900", "text-slate-200"].forEach((cssClass) =>
...
//funcao responsavel por criar o corpo da tabela
